#ifndef _HOME_SIYUAN_GENODE_20_05_BUILD_ARM_V7A_VAR_LIBCACHE_SYSCALL_SEL4_INCLUDE_SEL4_SHARED_TYPES_GEN_H
#define _HOME_SIYUAN_GENODE_20_05_BUILD_ARM_V7A_VAR_LIBCACHE_SYSCALL_SEL4_INCLUDE_SEL4_SHARED_TYPES_GEN_H
...
seL4_CNode_CapData_set_guard(seL4_CNode_CapData_t seL4_CNode_CapData, seL4_Uint32 v32) {
    /* fail if user has passed bits that we will override */
    seL4_DebugAssert((((~0x3ffff00 >> 8 ) | 0x0) & v32) == ((0 && (v32 & (1u << (31)))) ? 0x0 : 0));
...
seL4_CNode_CapData_set_guardSize(seL4_CNode_CapData_t seL4_CNode_CapData, seL4_Uint32 v32) {
    /* fail if user has passed bits that we will override */
    seL4_DebugAssert((((~0xf8 >> 3 ) | 0x0) & v32) == ((0 && (v32 & (1u << (31)))) ? 0x0 : 0));
