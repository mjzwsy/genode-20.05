...
#define CONFIG_6Q_FDT 			"setenv fdt_file imx6q-c-sabresd.dtb; fi; "
#define CONFIG_6DL_FDT 			"setenv fdt_file imx6dl-c-sabresd.dtb; fi; "
#elif CONFIG_MAIN_BOARD_IS_S2
#define CONFIG_6Q_FDT 			"setenv fdt_file imx6q-s2-sabresd.dtb; fi; "
#define CONFIG_6DL_FDT 			"setenv fdt_file imx6dl-s2-sabresd.dtb; fi; "
#elif CONFIG_MAIN_BOARD_IS_S3
#define CONFIG_6Q_FDT 			"setenv fdt_file imx6q-s3-sabresd.dtb; fi; "
#define CONFIG_6DL_FDT 			"setenv fdt_file imx6dl-s3-sabresd.dtb; fi; "
#endif
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"mmcargs=setenv bootargs console=${console},${baudrate} ${mxcfb0} ${mxcfb1} ${ldbmode} ${smp} " \
		"root=${mmcroot} fec.macaddr=${fec_mac}\0" \
	"loadbootscript=" \
