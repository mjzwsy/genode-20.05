...
#include <fsl_esdhc.h>
#include <miiphy.h>
#include <asm/arch-mxs/regs-ocotp.h> 
#include <u-boot/md5.h> 
#include <netdev.h>
#include "../../../drivers/video/mipi_common.h"
...
#define DISP0_PWR_PWM	IMX_GPIO_NR(1, 21)

#define LVDS_PWR_EN     IMX_GPIO_NR(6, 15)
#define LVDS_PWR_PWM     IMX_GPIO_NR(1, 17)
...
static iomux_v3_cfg_t const enet_pads[] = {
	...
	MX6_PAD_ENET_REF_CLK__ENET_TX_CLK	| MUX_PAD_CTRL(ENET_REF_CLK_PAD_CTRL),
...
int mx6_rgmii_rework(struct phy_device *phydev)
{
	...
	phy_write(phydev, MDIO_DEVAD_NONE, 0, 0x01);
...
static iomux_v3_cfg_t const mipi_pads[] = {
...
void power_on_and_reset_mipi_panel_6DL(void)
{
       ...
       imx_iomux_v3_setup_multiple_pads(mipi_pads, ARRAY_SIZE(mipi_pads));
       gpio_direction_output(MIPI_PWR_EN, 0);
       udelay(50);
...
void mipi_dsi_enable_controller(void)
{
       ...
       writel(0x1004400, DSI_VID_PKT_CFG);
       writel(0x00001fff, DSI_CMD_MODE_CFG);
       writel(0x254e3a12, DSI_TMR_LINE_CFG);
       writel(0x2582d71, DSI_VTIMING_CFG);
       writel(0x4040d00, DSI_TMR_CFG);
       writel(0x81, DSI_PHY_IF_CFG);
       ...
       dphy_write_control(0x44, 0x30);  /* PLL 27M ref_clk out to 1GHz */
